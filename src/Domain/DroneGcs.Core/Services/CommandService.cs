...
/// <summary>
/// Defines the contract for a command service that can execute commands.
/// </summary>
public interface ICommandService
{
    /// <summary>
    /// Executes a command line and returns the output.
    /// </summary>
    /// <param name="line">The command line to execute.</param>
    /// <param name="stoppingToken">A token to monitor for cancellation requests.</param>
    /// <returns>A list of output lines from the command execution.</returns>
    Task<IList<string>> Run(string line, CancellationToken stoppingToken);
}

/// <summary>
/// A worker service that can run a single task.
/// </summary>
public class CommandService(IVehicleService vehicleService, ILogger<CommandService> logger) : ICommandService
{
    private IList<string> commandOutputBuffer { get; set; } = [];

    /// <inheritdoc />
    public async Task<IList<string>> Run(string line, CancellationToken stoppingToken)
    {
        commandOutputBuffer = [];
