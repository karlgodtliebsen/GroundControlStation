...
public sealed record SysStatusMessage(byte SystemId, byte ComponentId, int? BatteryRemaining, float? BatteryVoltage, DateTimeOffset ReceivedAt) : MavLinkMessage(
    SystemId, ComponentId, MessageIds.SysStatus, ReceivedAt);
